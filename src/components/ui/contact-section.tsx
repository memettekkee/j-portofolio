...
export default function ContactSection() {
    return (
        <div className="mt-20 md:mt-40 max-w-screen-xl px-6 md:px-10 mx-auto text-center" id="contact">
            <h1 className="text-3xl md:text-4xl font-semibold tracking-wide underline underline-offset-8 decoration-secColor" data-aos="fade">
            ...
            <div className="mt-6 flex gap-6 md:gap-10 justify-center" data-aos="fade-up">
                <Link href={"https://www.linkedin.com/in/jihanathaaya/"} target="_blank" className="md:text-xl font-semibold tracking-wide flex gap-1 items-center group">
                    Linkedin
                ...
                <Link href={"mailto:athaayajihan@gmail.com"} target="_blank" className="md:text-xl font-semibold tracking-wide flex gap-1 items-center group">
                    Email
                    <span className="text-xl md:text-2xl group-hover:-translate-y-1 group-hover:translate-x-1 transition-all duration-200 ease-in-out">
                        <CgArrowTopRight />
                    </span>
